...
class RegistrationPlayers(commands.Cog):
    ...
    async def get_rules(self, ctx):
        ...
        await ctx.channel.send(
            ...
            "\nทีมงานได้ทำการปรับแต่งค่าต่าง ๆ ให้มีความเป็นเกมส์เอาตัวรอดให้มากที่สุด "
            "\nปิดการแสดงแผนที่ ที่เน้นความสมจริง ปิดตี้ (เพื่อปิดการแสดงชื่อผู้เล่น) "
            "\nปิดการใช้งานกับดักทุกชนิด เพื่อป้องกันการวางกับดักตามสถานที่สำคัญ "
            "\nรวมถึงตามถนน เนื่องจากกฎการวางระเบิดมักมีผู้แหกกฎกันประจำ "
            "\nทีมงานมีความตั้งใจให้ AI ของเกมส์มีบทบาทมากกว่าผู้เล่น เพื่อเพิ่มความ "
            "\nตื่นเต้น สร้างความท้อให้กับผู้เล่น และคัดกรองไว้เฉพาะผู้เล่นที่ใจสู้ 55555"
            "\n\n⚖ **เงื่อนไขและข้อตกลง**" +
